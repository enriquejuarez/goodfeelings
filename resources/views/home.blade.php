...
<!-- INICIA CARRUSEL -->
    ...
    <div class="row cuatro">
        ...
        <h1>{{ substr($sections["packages"],strpos($sections["packages"], '-')+1, strlen($sections["packages"])) }}</h1>
    ...
    <div class="row" style="padding-bottom: 38px;">
        <div class="col-xs-12 ">
            ...
            @endauth
            <h1 style="font-weight: 700; font-size: 30px; line-height: 30px; text-transform: uppercase; margin-bottom: 5px; letter-spacing: 0; margin-top: 3%;">{{ substr($sections["destinations"],strpos($sections["destinations"], '-')+1, strlen($sections["destinations"])) }}</h1>
        </div>
        <!-- Modal -->
    ...
    <div class="row cuatro ">
        ...
        <h1>{{ substr($sections["testimonies"],strpos($sections["testimonies"], '-')+1, strlen($sections["testimonies"])) }}</h1>
    ...
    <div class="row cuatro ">
        ...
        <h1 class="opcion-menu2">{{ substr($sections["services"],strpos($sections["services"], '-')+1, strlen($sections["services"])) }}</h1>
    ...
    <div class="row cuatro ">
        ...
        <h1 class="opcion-menu2">{{ substr($sections["we"],strpos($sections["we"], '-')+1, strlen($sections["we"])) }}</h1>
    </div>
    <div class="row">
        <div class="col-md-4 ">
